...
| [`docs/ADR-166-agent-learning-memory.md`](docs/ADR-166-agent-learning-memory.md) | Приватные append-only retrospectives, агрегированные метрики и promotion policy |
